    ...
    <ComponentCard title="Modal Based Alerts">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            Jules published the Q3 outbound sequence. Sending starts Monday at
            9:00 am across 240 mid-market accounts.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            Nick&apos;s demand-gen campaign is now live. Early performance
            metrics will appear on your dashboard within the hour.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            Pepper has 18 inbound leads waiting on manual review. Assign an
            owner to keep response times under five minutes.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
            Tony couldn&apos;t reach the Salesforce connector. Deal syncs are
            paused until the integration is restored.
          </p>
