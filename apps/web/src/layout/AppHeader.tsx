...
const AppHeader: React.FC = () => {
  ...
  return (
    <header
      data-aix-id="AIX-F2"
      className="glass-surface sticky top-0 flex w-full border-gray-200 z-99999 dark:border-gray-800 lg:border-b"
    >
            ...
            <div className="relative">
                ...
                <div className="absolute right-2.5 top-1/2 flex -translate-y-1/2 items-center gap-1">
                  <button
                    ...
                    className={`flex size-7 items-center justify-center rounded-lg transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-brand-500/50 disabled:cursor-not-allowed disabled:opacity-40 ${
                      listening
                  ...
                  <button
                    ...
                    onClick={() =>
                      window.dispatchEvent(
                        new CustomEvent("aix:open-command-palette")
                      )
                    }
                    className="inline-flex items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 transition-colors hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/50 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400 dark:hover:bg-white/[0.06]"
                  >
                    <span> ⌘ </span>
                    <span> K </span>
                  </button>
